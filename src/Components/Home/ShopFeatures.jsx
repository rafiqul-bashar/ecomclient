...
// { img: payment, title: "Flexible Payment", text: "Pay on delivery or with card online." }
const features = [
  {
    img: delivery,
    title: "Free Shippin",
    text: "Over $100 worth of shopping.",
  },
  {
    img: moneyback,
    title: "Money Return",
    text: "Within 30 days fo an exchange.",
  },
  {
    img: support,
...
export default function ShopFeatures() {
  return (
    <div className="select-none">
      <div className="container py-4 gap-4 grid grid-cols-2 md:grid-cols-3">
        {features.map((feature, index) => (
          <div
            key={index}
            className=" flex flex-col text-center md:flex-row  items-center justify-center  md:justify-start space-x-2"
          >
