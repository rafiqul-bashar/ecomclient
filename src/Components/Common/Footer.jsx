  ...
  return (
    <footer className='bg-[#2c3640] text-white select-none'>
      <div className="container grid grid-cols-1  md:grid-cols-4">
        <div>
          <Heading className='my-3' as='h3' size='md' fontWeight={"medium"}>Custom Links</Heading>
        ...
        <div>
          <Heading className='my-3' as='h3' size='md' fontWeight={"medium"}>My Account</Heading>
        ...
        <div>
          <Heading className='my-3' as='h3' size='md' fontWeight={"medium"}>Customer Services</Heading>
        ...
        <div>
          <Heading className='my-3 text-green' as='h3' size='md' fontWeight={"medium"} >HemiStore</Heading>
          <h5 className='footerLink'>Contact</h5>
      ...
      <div className='text-center py-3 text-lg text-[#8b9198]'>&copy; <span className='text-green'> HemiStore </span>| 2022 - devoloped by <span className='underline'><a href="https://rafiqul-bashar.vercel.app/" target="_blank" rel='noreferrer'>Rafiqul Bashar</a></span> </div>
    </footer>
  )
}
